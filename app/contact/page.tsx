...
export const metadata: Metadata = {
  ...
  description: 'Get in touch with ThinkSuite. Book a free discovery call, share your project requirements, and get a custom proposal built around your goals, wherever you are.',
  keywords: [
