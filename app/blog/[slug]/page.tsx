      ...
      <main>
        ...
        <div className="article-breadcrumb">
          <div className="container">
            ...
            <Link href="/blog">AI News</Link><span>›</span>
              ...
              <div className="article-main">
                ...
                <div className="article-tags">
                  {article.tags?.map(tag => (
                    <Link key={tag} href={`/blog?tag=${encodeURIComponent(tag)}`} className="blog-tag">#{tag}</Link>
                  ))}
                </div>
                ...
                <div className="sidebar-card">
                  ...
                  <div className="sidebar-meta-list">
                    {[
                      ...
                      <div key={item.label}><span>{item.label}</span><span className={item.label === 'Impact' ? 'score-pill' : ''}>{item.value}</span></div>
                    ))}
                  </div>
                </div>
